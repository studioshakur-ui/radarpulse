...
export function TechPremiumHero({ className }: { className?: string }) {
  return (
    <section className={cn("relative", className)}>
      {/* Container plus large + layout vertical */}
      <div className="mx-auto w-full max-w-[1560px] px-4 pb-14 pt-16 sm:px-6 lg:px-10">
        <ScrollReveal dir="up">
          <div className="max-w-5xl">
            ...
            <p className="mt-5 max-w-3xl text-base text-subtext sm:text-lg">
        ...
        {/* STAGE full-width en dessous (plus de G/D) */}
        <div className="mt-10">
          <ScrollReveal dir="up" delay={0.04}>
            <div className="rounded-[36px] border border-line/20 bg-surface/55 p-4 sm:p-5 shadow-glow backdrop-blur">
