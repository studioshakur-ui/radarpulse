        ...
        <div className="space-y-4">
          ...
          >
            <div className="grid gap-3 md:grid-cols-2">
              <div className="rounded-2xl border border-line/20 bg-bg/60 p-4">
            ...
            {detail.tasks.length === 0 ? (
              ...
              <div className="space-y-2">
                {detail.tasks.map((task) => (
                  <label
                    key={task.id}
                    className="flex items-start gap-3 rounded-2xl border border-line/20 bg-bg/60 p-3"
                  >
                    <input
                      type="checkbox"
          ...
          >
            <div className="grid gap-3">
              <Link
                ...
                className="inline-flex items-center justify-between rounded-2xl border border-line/20 bg-bg/60 px-4 py-3 text-sm font-semibold text-text transition hover:bg-elevated"
              >
