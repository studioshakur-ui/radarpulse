...
export default function RequestAccessPage() {
  ...
  const cardInitial = reduced ? { opacity: 1, y: 0 } : { opacity: 0, y: 12, filter: "blur(6px)" };
  ...
  return (
    <div className="relative min-h-screen bg-bg text-text">
      ...
      <main className="relative mx-auto max-w-xl px-4 pt-20">
        <motion.div
          ...
          transition={{ duration: 0.65, ease: [0.21, 0.61, 0.35, 1] }}
        >
          ...
          {!done ? (
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="mt-1 w-full rounded-2xl border border-border/30 bg-bg/55 px-4 py-2 text-sm outline-none transition focus:ring-2 focus:ring-accent/40"
              ...
              <div>
                ...
                <select
                  ...
                  className="mt-1 w-full rounded-2xl border border-border/30 bg-bg/55 px-3 py-2 text-sm outline-none transition focus:ring-2 focus:ring-accent/40"
                >
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <button
                  type="submit"
                  className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl px-5 py-3 text-sm font-semibold text-bg shadow-glow transition hover:opacity-[0.96] active:scale-[0.99]"
                  style={{
                    background:
                ...
                <a
                  href={mailto}
                  className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl border border-border/30 bg-surface/70 px-5 py-3 text-sm font-semibold text-text shadow-soft transition hover:bg-elevated/70 hover:border-border/45 active:scale-[0.99]"
                >
            ...
            <div className="mt-6 rounded-2xl border border-good/20 bg-good/10 p-4">
              ...
              <div className="mt-4 flex flex-col gap-2 sm:flex-row">
                <a
                  href={mailto}
                  className="inline-flex items-center justify-center gap-2 rounded-2xl px-5 py-3 text-sm font-semibold text-bg shadow-glow transition hover:opacity-[0.96] active:scale-[0.99]"
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(168,85,247,0.95), rgba(139,92,246,0.85), rgba(236,72,153,0.22))",
                  }}
                ...
                <Link
                  to="/explore"
                  className="inline-flex items-center justify-center gap-2 rounded-2xl border border-border/30 bg-surface/70 px-5 py-3 text-sm font-semibold text-text shadow-soft transition hover:bg-elevated/70 hover:border-border/45 active:scale-[0.99]"
                >
